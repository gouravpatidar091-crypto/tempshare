// ============================================================
// server.js — TempShare entry point (Debugged)
// ============================================================
...
// ── Ensure /uploads dir exists (for any local fallback, though we use Supabase) ──
...
// ── Boot ─────────────────────────────────────────────────────
app.listen(PORT, () => {
  console.log(`✅ TempShare running on port ${PORT}`);
  console.log(`📦 Using Supabase bucket: ${process.env.SUPABASE_BUCKET || 'tempshare-files'}`);
});
